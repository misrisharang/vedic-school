...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            <FadeIn className="max-w-2xl">
              ...
              <p className="text-lg md:text-xl text-foreground/80 leading-relaxed mb-4 max-w-xl">
              ...
              <a href="#how-we-do-it" className={buttonVariants({ size: 'lg' })}>
      ...
      {/* COUNTRIES WE SERVE */}
      <section className="py-6 md:py-8 bg-[#F0EBE1]/70 border-y border-border/40 overflow-hidden relative" aria-label="Countries We Serve">
        <div className="container mx-auto px-4 mb-3 text-center">
          <h2 className="sage-eyebrow mb-0">COUNTRIES WE SERVE</h2>
        </div>
        <div className="relative w-full overflow-hidden [mask-image:linear-gradient(to_right,transparent,black_8%,black_92%,transparent)]">
          <div className="animate-ticker flex items-center gap-4 md:gap-6 py-2">
            {[...countries, ...countries, ...countries, ...countries].map((country, idx) => (
              <div
                key={`${country.name}-${idx}`}
                className="inline-flex items-center gap-3 px-5 py-2.5 rounded-full bg-white/80 border border-border/40 shadow-2xs backdrop-blur-xs shrink-0 select-none hover:border-primary/40 hover:bg-white hover:shadow-xs transition-all"
              >
                <span className="text-2xl md:text-3xl leading-none filter drop-shadow-2xs" aria-hidden="true">
                  {country.flag}
                </span>
                <span className="font-serif text-sm md:text-base font-medium text-foreground whitespace-nowrap">
                  {country.name}
                </span>
              </div>
            ))}
      ...
      {/* HOW WE DO IT */}
      <section id="how-we-do-it" className="py-16 md:py-20 bg-accent/50 border-y border-border/30">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <FadeIn delay={0.1}>
              <div className="bg-white p-10 md:p-12 rounded-[2rem] shadow-sm border border-border/50 h-full flex flex-col">
                <div className="w-14 h-14 rounded-full bg-secondary/10 flex items-center justify-center mb-8 text-secondary">
                ...
                <h3 className="text-2xl md:text-3xl font-serif text-foreground mb-2">Vedic Maths</h3>
                <p className="text-secondary font-medium mb-4">Build fluency and confidence with numbers.</p>
                ...
                <Button className="w-full sm:w-auto self-start">Join Sunday's free demo</Button>
                <Link href="/vedic-maths" className="text-primary font-medium inline-flex items-center gap-2 hover:gap-3 transition-all mt-4 text-sm">
            ...
            <FadeIn delay={0.2}>
              <div className="bg-white p-10 md:p-12 rounded-[2rem] shadow-sm border border-border/50 h-full flex flex-col">
                <div className="w-14 h-14 rounded-full bg-primary/10 flex items-center justify-center mb-8 text-primary">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H20v20H6.5a2.5 2.5 0 0 1 0-5H20"/></svg>
                </div>
                <h3 className="text-2xl md:text-3xl font-serif text-foreground mb-2">Curriculum-Aligned Classes</h3>
                ...
                <Button className="w-full sm:w-auto self-start">Book a personal assessment</Button>
                <Link href="/curriculum-aligned" className="text-primary font-medium inline-flex items-center gap-2 hover:gap-3 transition-all mt-4 text-sm">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
            ...
            <FadeIn delay={0.2}>
              ...
              <div className="space-y-4 text-lg text-foreground/80 leading-relaxed mb-8">
                <p>
                  Hi, I'm Meenakshi Khar. I've spent 15+ years teaching Maths, and over that time I've learnt that the problem isn't always the problem on the page.
                </p>
                <p>
      ...
      <section id="testimonials" className="py-16 md:py-20 bg-background">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <TestimonialPlaceholder delay={0.3} />
          </div>
        </div>
      </section>
      ...
      >
        <div className="max-w-2xl mx-auto text-left">
          <TwoPathCTA
            ...
            onDark
            paths={[
              { label: 'Vedic Maths', description: 'Experience the teaching method in a real class.', cta: "Join Sunday's free demo" },
              { label: 'Curriculum-Aligned Classes', description: 'Understand what your child needs to move forward.', cta: 'Book a personal assessment' },
            ]}
          />
        </div>
      </ClosingCTABand>
